...
MOSAIC, PGL, and MXGL are evaluated using the included \(p=5000\) component-F1-selected configurations and component-specific validation thresholds. The output reports supra-adjacency and component-level AUC and F1 across all \((\kappa,\mathrm{SNR})\) conditions.
